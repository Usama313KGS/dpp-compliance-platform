  ...
  return (
    <aside className="w-56 bg-white border-r border-gray-200 flex flex-col min-h-full shrink-0">
      ...
      <div className="p-3 border-t border-gray-200">
        <div className="text-xs text-gray-500 text-center">DPP Compliance Platform</div>
        <div className="text-xs text-gray-400 text-center mt-1">Schema v1.1.0 active</div>
      </div>
    </aside>
  );
}
